...
#define  MatchParserLinkTypeName @"MatchParserLinkTypeName"
@class MatchParser;
...
-(MatchParser*)getMatchWithWidth:(float)width;
-(MatchParser*)getMatchWithWidth:(float)width complete:(void(^)(MatchParser *parser,id data))complete data:(id)data;
...
@property(nonatomic,strong) id<MatchParserDelegate> data;
